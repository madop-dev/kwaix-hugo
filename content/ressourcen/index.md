...
{{< cards cols="3" >}}
{{< card icon="backlog" title="Use-Case-Checkliste" text="Welche Aufgaben im Arbeitsalltag eignen sich für KI? Eine strukturierte Checkliste für den ersten Überblick." >}}
{{< card icon="proof" title="KI-VO Artikel 4" text="Was die EU KI-Verordnung von Unternehmen verlangt — verständlich erklärt, ohne Juristendeutsch." >}}
{{< card icon="policy" title="KI-Policy Vorlage" text="Ein Ausgangspunkt für Ihre interne KI-Richtlinie: Dos & Don'ts, Datenschutz, Tool-Freigaben." >}}
{{< card icon="prompt" title="Prompting-Grundlagen" text="Was ist ein guter Prompt? Die wichtigsten Prinzipien kompakt — für Einsteiger und Fortgeschrittene." >}}
{{< card icon="roi" title="ROI-Rechner" text="Wie viel Zeit spart KI wirklich? Konservativer Rechner für Zeitersparnis im Arbeitsalltag." >}}
