...
faqItems:
  ...
  - q: "Was ist der Unterschied zwischen KWAIX und Anbietern wie IHK, TÜV Rheinland, Haufe Akademie oder Online-Kursen wie DELST?"
    a: "Standardanbieter wie IHK, DELST oder IS-FOX bieten Online-Kurse mit Abschlusstest — das Zertifikat steht im Vordergrund, der Inhalt ist für alle gleich. Haufe Akademie und TÜV Rheinland bieten offene Seminare für gemischte Teilnehmergruppen. KWAIX trainiert ausschließlich Ihr Team, mit Use Cases aus Ihrem Alltag: Handwerk, Dienstleistung, Handel, Industrie oder Beratung — branchenspezifisch, direkt anwendbar. Enthalten ist nicht nur der Kompetenznachweis nach Artikel 4 KI-Verordnung, sondern auch Prompt-Bibliothek, KI-Policy-Template und Handout. Die EU KI-Verordnung schreibt keinen bestimmten Anbieter vor — maßgeschneidertes Inhouse-Training gilt als besonders geeignet, wenn es den tatsächlichen KI-Einsatz im Unternehmen abdeckt."
...
{{< cards cols="4" >}}
{{< card icon="policy" title="Policy-Template" text="Vorlage für Ihre unternehmensinterne KI-Richtlinie" >}}
{{< card icon="prompt" title="Prompt-Bibliothek" text="Erprobte Vorlagen für konkrete Aufgaben im Arbeitsalltag" >}}
{{< card icon="backlog" title="Use-Case-Backlog" text="Priorisierte Anwendungsfälle für den direkten Einsatz" >}}
...
Ja. Alle Teilnehmenden erhalten einen [Kompetenznachweis](/ki-verordnung/kompetenznachweis/) gemäß Artikel 4. Pflicht seit 2. August 2025 für alle Unternehmen, die KI-Systeme betreiben.
