...
heroCards:
  - type: roi
    ...
    subtitle: "Besser vorbereitet"
  - type: backlog
    title: "Berichte"
    subtitle: "Auf das Wesentliche"
  - type: policy
    title: "Kommunikation"
    subtitle: "Klar, adressatengerecht"
faqItems:
  - q: "Welche Management-Aufgaben eignen sich für KI?"
    a: "Am stärksten: Lange Berichte und Dokumente auf das Wesentliche zusammenfassen, Entscheidungsvorlagen aus verschiedenen Quellen strukturieren, Meeting-Agendas vorbereiten, komplexe Sachverhalte für verschiedene Zielgruppen (Team, Aufsichtsrat, Kunden) unterschiedlich formulieren, Szenarien-Vergleiche strukturieren und Strategiepapiere als Erstenwurf aufsetzen."
  - q: "Kann KI bei strategischen Entscheidungen helfen?"
    a: "KI trifft keine Entscheidungen und kann Strategie nicht ersetzen. Was KI kann: Optionen auf Basis Ihrer Eingaben strukturieren, Vor- und Nachteile auflisten, Entscheidungskriterien systematisieren und einen ersten Entwurf für die Entscheidungsvorlage erstellen. Den Urteilsakt übernimmt die Führungskraft."
...
- 3 Handlungsoptionen → strukturierte Entscheidungsvorlage in 10 Minuten
- Komplexer Sachverhalt → 3 Varianten für Team, Beirat, Kunden in 5 Minuten
...
**Welche Management-Aufgaben eignen sich für KI?**
Berichte zusammenfassen, Entscheidungsvorlagen strukturieren, Meetings vorbereiten, Kommunikation adressatengerecht anpassen, Szenarien durchdenken und Strategiepapiere als Erstenwurf aufsetzen.

**Kann KI bei strategischen Entscheidungen helfen?**
