...
tags: ["KI-Verordnung", "Artikel 4", "Kompetenznachweis", "KI-Schulungspflicht", "Compliance"]
categories: ["KI-Verordnung"]
schemaType: "article"
faqItems:
  - q: "Was muss ein Kompetenznachweis nach Artikel 4 KI-VO enthalten?"
    a: "Ein rechtskonformer Kompetenznachweis enthält: Name und Funktion der geschulten Person, Datum und Dauer der Schulung, Schulungsinhalte (Themenblöcke, Lernziele), Angaben zum Trainer bzw. zur Trainingsorganisation sowie eine Bestätigung der vermittelten Kompetenzen. Er ist im Unternehmen aufzubewahren und bei Prüfungen vorzulegen."
  - q: "Wer darf einen Kompetenznachweis nach Artikel 4 ausstellen?"
    a: "Die EU KI-Verordnung schreibt keine akkreditierte Stelle vor. Der Nachweis kann von jedem qualifizierten Trainingsanbieter ausgestellt werden, der die Anforderungen von Artikel 4 inhaltlich abdeckt. Entscheidend ist der Inhalt des Nachweises, nicht die Herkunft des Stempels."
  - q: "Reicht ein Online-Kurs für den Kompetenznachweis nach Artikel 4?"
    a: "Ein Online-Kurs kann ausreichen, wenn er die Inhalte von Artikel 4 abdeckt und einen vollständigen Kompetenznachweis ausstellt. Entscheidend ist nicht das Format, sondern ob die Kompetenz nachweisbar vermittelt wurde. Praxisnahes Live-Training mit eigenen Use Cases ist deutlich wirksamer als ein generisches Video-Modul."
  - q: "Müssen alle Mitarbeitenden den Kompetenznachweis haben?"
    a: "Alle Mitarbeitenden, die KI-Systeme im Berufsalltag nutzen, sind betroffen. Das umfasst Vertriebler, die ChatGPT für Angebote nutzen, ebenso wie Führungskräfte, die KI-gestützte Analysetools verwenden. Reine Verwaltungsmitarbeitende ohne KI-Berührung sind nicht direkt betroffen."
  - q: "Wie lange ist der Kompetenznachweis gültig?"
...
2. Risiken, Grenzen und Qualitätskontrolle
3. Datenschutz und DSGVO-konforme Nutzung
4. Praxisanwendung mit eigenen Use Cases

**Details zum Nachweis:** [/ki-verordnung/kompetenznachweis/](/ki-verordnung/kompetenznachweis/)  
**Training buchen:** [/leistungen/ki-training-live/](/leistungen/ki-training-live/)  
**Kostenloses Vorgespräch:** [info@kwaix.de](mailto:info@kwaix.de?subject=Kompetenznachweis%20Artikel%204)
