...
heroCards:
  - type: training
    title: "Jena"
    subtitle: "Optik · Photonik · Hightech"
  - type: backlog
    title: "Präzisionstechnologie"
    subtitle: "Carl Zeiss · Jenoptik · KMU"
  - type: proof
    title: "KI-VO konform"
...
**Typische Trainingsthemen in Jena:**
- Technische Produktdokumentation und Handbücher (Optik, Messtechnik)
- Qualitätsprotokolle und Kalibrierberichte standardisieren
- Patentanmeldungen vorbereiten und Schutzrechtskommunikation
- Ausgründungen: Pitch, Förderantrag, Produktkommunikation

{{< kpiStrip k1_label="Standort" k1_value="Jena & Thüringen" k2_label="Format" k2_value="Remote (Standard)" k3_label="Training ab" k3_value="2.400 € netto" k4_label="Nachweis" k4_value="Art. 4 KI-VO" >}}

{{% /section %}}

{{% section tone="tint" %}}

## Use Cases für Jenaer Technologieunternehmen

{{< cards cols="3" >}}
{{< card icon="policy" title="Technische Produktdokumentation" text="Produktspezifikationen, Handbücher und Datenblätter für Optik- und Messtechnikprodukte schneller und einheitlicher erstellen." >}}
{{< card icon="backlog" title="Qualität & Kalibrierung" text="Kalibrierprotokolle, Prüfberichte und Qualitätssicherungsdokumentation nach DIN/ISO mit KI-Unterstützung strukturiert aufbauen." >}}
{{< card icon="prompt" title="Schutzrechte & Patent" text="Patentrecherche-Zusammenfassungen, Anmeldungsunterlagen und technische Beschreibungen für Schutzrechte vorbereiten." >}}
{{< card icon="training" title="Spin-offs & Startups" text="Ausgründungen aus der FSU Jena: Pitchdeck, Förderantrag und Produktkommunikation professionell aufbauen." >}}
{{< card icon="backlog" title="Internationaler Vertrieb" text="Technische Verkaufsunterlagen und Kundenkommunikation auf Englisch für internationale Märkte schneller produzieren." >}}
{{< card icon="proof" title="KI-VO Nachweis" text="Artikel 4 gilt für alle Hightech-Unternehmen, die KI-Systeme in Prozessen einsetzen." href="/ki-verordnung/kompetenznachweis/" cta="Kompetenznachweis ansehen" >}}
{{< /cards >}}

{{< cta primaryHref="mailto:info@kwaix.de?subject=KI-Training%20Jena%20anfragen" primaryText="Vorgespräch für Jena anfragen" secondaryHref="/ki-training-kosten/" secondaryText="Preise ansehen" >}}
...
{{< cta primaryHref="mailto:info@kwaix.de?subject=KI-Training%20Jena%20anfragen" primaryText="Vorgespräch anfragen" secondaryHref="/leistungen/ki-training-live/" secondaryText="KI-Training ansehen" >}}
