...
heroCards:
  ...
  - type: backlog
    title: "Use Cases"
    subtitle: "Aus dem Handwerksalltag"
  - type: proof
    title: "KI-VO konform"
...
- **Format:** [KI-Kickoff](/leistungen/ki-kickoff/) (90 Min) + [KI-Training Live](/leistungen/ki-training-live/) für Büro und/oder Meisterteam
- **Voraussetzung:** kein IT-Vorwissen nötig
- **Ergebnis:** messbare Zeitersparnis bei Routinetexten und Kommunikationsaufgaben
...
{{< cards cols="3" >}}
{{< card icon="default" title="01 Vorgespräch" text="Kurzes Kennenlernen: Betriebsgröße, Bereiche, konkrete Aufgaben. 30 Min, kostenfrei." >}}
{{< card icon="backlog" title="02 KI-Kickoff" text="90 Min Workshop: Welche Aufgaben sind am lohnendsten? Prioritäten, Risiken, nächste Schritte." >}}
{{< card icon="training" title="03 Training" text="Praxisnahes Live-Training mit echten Aufgaben aus Ihrem Betrieb. Büro und/oder Meisterteam." >}}
{{< card icon="prompt" title="04 Prompt-Bibliothek" text="Erprobte Vorlagen für Angebote, Mails und Protokolle — direkt einsetzbar." >}}
{{< card icon="proof" title="05 Kompetenznachweis" text="Nachweis gemäß Artikel 4 KI-Verordnung für alle Teilnehmenden." >}}
