...
draft: false
canonical: "https://kwaix.de/ki-vo/faq/"
schemaType: "faq"
heroIcon: "proof"
faqItems:
  ...
  - q: "Bin ich als KMU Anbieter oder Betreiber?"
    a: "Wenn Ihr Unternehmen ChatGPT, Microsoft Copilot, Google Gemini oder andere KI-Tools kauft und im Arbeitsalltag einsetzt, sind Sie Betreiber. Wenn Sie eigene KI-Systeme entwickeln oder KI-Systeme für andere anpassen und vermarkten, sind Sie Anbieter. Die meisten KMU sind Betreiber."
...
Seit dem 2. August 2025 gilt Artikel 4 der KI-Verordnung: die **Kompetenzpflicht**. Unternehmen, die KI-Systeme einsetzen, müssen sicherstellen, dass ihre Mitarbeitenden über ausreichende KI-Kompetenz verfügen — und das nachweisbar dokumentieren. Details: [Artikel 4 KI-VO](/ki-vo/artikel-4/).
...
**Bin ich als KMU Anbieter oder Betreiber?**
Wer ChatGPT, Microsoft Copilot oder andere KI-Tools kauft und im Arbeitsalltag einsetzt, ist **Betreiber**. Wer eigene KI-Systeme entwickelt oder für andere anpasst, ist **Anbieter**. Die meisten KMU sind Betreiber.

**Was passiert, wenn wir nichts tun?**
Artikel 99 KI-VO sieht Geldbußen vor: bis zu 15 Mio. € oder 3 % des Jahresumsatzes für Verstöße gegen Betreiberpflichten. Kurzfristig ist das Risiko für KMU primär in Vertrags- und Haftungsfragen zu sehen.

**Müssen wir jetzt sofort alle Mitarbeitenden schulen?**
Artikel 4 gilt seit dem 2. August 2025. Wer KI-Tools im Einsatz hat, sollte zeitnah handeln. Pragmatischer Einstieg: [KI-Kickoff](/leistungen/ki-kickoff/) zur Priorisierung, dann gezielt schulen und dokumentieren.

**Was ist der Unterschied zwischen KI-Verordnung und DSGVO?**
Die DSGVO regelt den Schutz personenbezogener Daten. Die EU KI-Verordnung regelt KI-Systeme selbst. Beide gelten parallel. Mehr: [Datenschutz & DSGVO beim KI-Einsatz](/ki-vo/datenschutz-dsgvo/).

**Brauchen wir eine KI-Policy?**
Die KI-Verordnung schreibt keine KI-Policy explizit vor, aber sie ist die praktischste Methode, Betreiberpflichten und Kompetenzpflichten zu erfüllen. Details: [KI-Policy für Unternehmen](/ki-vo/ki-policy/).

{{< cta primaryHref="mailto:info@kwaix.de?subject=KI-VO%20Umsetzung%20anfragen" primaryText="Umsetzung besprechen" secondaryHref="/ki-vo/" secondaryText="KI-VO Übersicht" >}}
...
{{< cards cols="4" >}}
{{< card icon="proof" title="1. August 2024" text="Inkrafttreten der Verordnung (EU) 2024/1689." >}}
{{< card icon="policy" title="2. Februar 2025" text="Verbotene KI-Praktiken gelten (Artikel 5). Z.B. Social Scoring, manipulative KI-Systeme." >}}
{{< card icon="training" title="2. August 2025" text="Artikel 4 KI-Kompetenzpflicht gilt. Betreiber müssen Schulungen nachweisen können." >}}
{{< card icon="backlog" title="2. August 2026" text="Vollständige Anwendung der Verordnung für Hochrisiko-KI-Systeme (Anhang III)." >}}
{{< /cards >}}

{{< cta primaryHref="/leistungen/ki-training-live/" primaryText="Jetzt schulen & nachweisen" secondaryHref="/ki-vo/artikel-4/" secondaryText="Artikel 4 im Detail" >}}
